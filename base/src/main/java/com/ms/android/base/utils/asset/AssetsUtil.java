...
import com.ms.android.base.utils.SharePreferenceUtil;
...
public class AssetsUtil{
    ...
    public final static String FILE_NAME="orange";
    public final static String FILE_NAME21="orange21";
     ...
     * @param context
     */
    public void initAssetToSD(Context context,boolean isDefault){
        if ((boolean) SharePreferenceUtil.getPreference(context,IS_HAS_WRITE_SD, true)) {
            if (isDefault){
                ...
                assetToSD(FILE_NAME21, SDUtil.getDiskCacheDir(context)+ "/"+FILE_NAME21,context);
            }
